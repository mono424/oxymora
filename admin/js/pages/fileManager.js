let fileManager = {
  ...
  init(){
    ...
    fileManager.element.on('dragover', '.path a', fileManager.dir_dragOver);
    fileManager.element.on('dragleave', '.path a', fileManager.dir_dragLeave);
    fileManager.element.on('drop', '.path a', fileManager.dir_drop);
    ...
    fileManager.element.on('dragend', '.dirs .dir', fileManager.dir_dragEnd);
    ...
    fileManager.element.on('dragend', '.files .file', fileManager.file_dragEnd);
